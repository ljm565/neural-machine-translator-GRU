...
* ### Neural Machine Translator GRU 모델별 결과
    ...
    * 기계 번역 결과 샘플<br>
        * Model with Attention
            ...
            ```
            <img src="images/nmt_GRU_Attn_attention0.jpg" width="33%">
            <img src="images/nmt_GRU_Attn_attention1.jpg" width="33%">
            <img src="images/nmt_GRU_Attn_attention2.jpg" width="33%"><br><br><br>
        ...
        * Scheduled Sampling Model with Attention
            ...
            ```
            <img src="images/nmt_GRU_Attn_ss_attention0.jpg" width="33%">
            <img src="images/nmt_GRU_Attn_ss_attention1.jpg" width="33%">
            <img src="images/nmt_GRU_Attn_ss_attention2.jpg" width="33%"><br><br><br>
